...
export const Navbar = () => {
  ...
  const [
    ...
    setIsClosePostModalConfirmationOpen,
  ] = useState(false);
      ...
      <>
          ...
          <div className="nav-upper-section">
            <div className="nav-head" onClick={() => navHeadClickHandler()}>
              ...
              <div className="nav-img-container">
                <img
                  src={require("../../resources/images/raj-sphere.png")}
                  alt=""
                  className="nav-img"
                />
              </div>
              <p className="nav-text">CommuniTree</p>
            </div>
            <div className="nav-links">
              ...
              >
                <MdOutlineExplore className="nav-img" />{" "}
          ...
          {editedData?.firstName === undefined ? (
            ...
            <div className="profile" onClick={() => profileNavHandler()}>
              ...
              <div className="content">
                <p className="profile-name">{`${editedData?.firstName} ${
                  editedData?.lastName !== undefined ? editedData?.lastName : ""
                }`}</p>
        ...
        {isPostModalOpen && (
          ...
          >
            ...
            >
              <button className="close-btn" onClick={() => closePostModal()}>
                <TfiClose />
              </button>
              <div className="img-and-text">
                ...
                <textarea
                  ...
                  onChange={(event) =>
                    setPostInput({ ...postInput, content: event.target.value })
                  }
                ></textarea>
              </div>
              {postInput?.pic !== "" && (
              ...
              <div className="post-modal-foot">
                <div className="post-modal-fileinput-container">
                  ...
                  <input
                    ...
                    name=""
                    id="imgInput"
                    className="post-modal-fileinput"
                    accept="image/*"
                ...
                <div className="btn-container">
                  <button
                    className={
                      postInput.content === "" ? "disabled-btn" : "btn"
                    }
                    disabled={postInput.content === ""}
                  ...
                  <button
                    ...
                    onClick={() => postModalCancelClickHandler()}
                  >
                    Cancel
                  </button>
                </div>
        ...
        {isClosePostModalConfirmationOpen && (
          <div
            className="post-modal-confirmation-dialog-container"
            onClick={() => setIsClosePostModalConfirmationOpen(false)}
          >
            <div
              className="post-modal-confirmation-dialog"
              onClick={(event) => event.stopPropagation()}
            >
              ...
              <div className="btn-container">
                <button
                  className="save"
                  onClick={() => saveConfirmationHandler()}
                >
                  Save
                </button>
                <button
